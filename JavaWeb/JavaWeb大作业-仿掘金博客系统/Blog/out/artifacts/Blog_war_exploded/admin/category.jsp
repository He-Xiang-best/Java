                             ...
                             <td align="center">
                                    <button class="layui-btn" data-index="${c.categoryId}" data-type="editor">编辑</button>
                           			<button style="margin-right: 10px;margin-top: 10px;"
                                            ...
                                            data-index="${c.categoryId}"  data-type="remove">删除</button>
                            </td>
                        </tr>
                            ...
                            <td align="center">
                             ...
                             <td align="center">
                                    <button  class="layui-btn"
                                            data-index="${cc.categoryId}" data-type="editor">编辑</button>
                           			<button style="margin-right: 10px;margin-top: 10px;"
                                            class="layui-btn layui-btn-danger layui-btn-mini"
                                            data-index="${cc.categoryId}"  data-type="remove">删除</button>
                            </td>
                        </tr>
                        </c:forEach>
