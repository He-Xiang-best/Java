                ...
                <c:forEach items="${comments}" var="c">
                    <tr>
                        ...
                        <td align="center">
                            ...
                            <button style="margin-right: 10px;margin-top: 10px;" type="button" class="layui-btn layui-btn-danger layui-btn-mini" id="del"
                                    data-type="remove" data-index="${c.commentId }">删除</button>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
