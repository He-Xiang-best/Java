                       ...
                       <c:when test="${a.issueType eq 1}">
                        ...
                        <td align="center">
                            <button type="button" class="layui-btn layui-btn-danger layui-btn-mini"
                                    ...
                                    onclick="delFun(${a.articleId })">审核通过
                            </button>
                            <br/>
                        <button type="button" class="layui-btn layui-btn-danger layui-btn-mini" id="del"
                                style="margin-right: 10px;margin-top: 10px" data-type="remove" data-index="${a.articleId
                                 }">删除
                        </button>
                        </td>
                    </tr>
    ...
    function delFun(ar_id) {
        ...
        javaex.confirm({
            ...
            confirm : function() {
                ...
                $.ajax({
                    type:"post",
                    url:'${pageContext.request.contextPath}/admin/cancel_report_ar',
                    data:{ar_id:ar_id},
